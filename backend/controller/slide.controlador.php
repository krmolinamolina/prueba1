...
class ControladorSlide{
	...
	static public function ctrActualizarSlide($datos){
		...
		if($datos["subirFondo"] != null){
			...
			if($datos["imgFondo"] != "view/img/slide/default/fondo.jpg"){	
			...
			$directorio = "../view/img/slide/slide".$datos["id"];
	...
	public function ctrEliminarSlide(){
		...
		if(isset($_GET["idSlide"])){
			...
			if($_GET["imgFondo"] != "view/img/slide/default/fondo.jpg"){
			...
			rmdir('../view/img/slide/slide'.$_GET["idSlide"]);
