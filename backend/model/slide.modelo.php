...
class ModeloSlide{	
	...
	static public function mdlActualizarSlide($tabla, $rutaFondo, $rutaProducto, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, tipoSlide = :tipoSlide, estiloImgProducto = :estiloImgProducto, estiloTextoSlide = :estiloTextoSlide, imgProducto = :imgProducto, imgFondo = :imgFondo, titulo1 = :titulo1, titulo2 = :titulo2, titulo3 = :titulo3, boton = :boton, url = :url WHERE id = :id");
