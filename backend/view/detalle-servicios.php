                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Detalle Servicios</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                        <div class="project-details-title">
                                            <h2><span class="profile-details-name-nn">Servicios a: </span> XXXXXXXXX</h2>
                                        </div>
                                        <ul id="adminpro-demo2" class="comment-action-st collapse">
                                            ...
                                            <li><a href="#">Ocultar perfil</a>
                                            </li>
                                            <li><a href="#">Activar perfil</a>
                                            </li>
                                            <li><a href="#">Desactivar perfil</a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="project-details-mg">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    <div class="project-details-st">
                                                        <span><strong>Mensajes:</strong></span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                    <div class="project-details-dt">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="project-details-tab">
                                            <ul class="nav nav-tabs res-pd-less-sm">
                                                <li class="active"><a data-toggle="tab" href="#home">Mensajes de usuario</a>
                                                </li>
                                                <li><a data-toggle="tab" href="#menu1">Ultimas actividades</a>
                                                </li>
                                            </ul>
                                                                        ...
                                                                        <div class="col-lg-5">
                                                                            <div class="comment-replay-profile">
                                                                                <div class="btn-group">
                                                                                    ...
                                                                                    <button class="btn btn-white profile-details-name-nn btn-xs"><i class="fa fa-heart"></i> 10 Love</button>
                                ...
                                <div class="sparkline7-graph project-details-price-hd">
                                    <div class="single-skill">
                                        <div class="progress-circular">
                                            <input type="text" class="knob" value="0" data-rel="85" data-linecap="round" data-width="90" data-bgcolor="#999" data-fgcolor="#03a9f4" data-thickness=".10" data-readonly="true" disabled>
                                        </div>
                                    ...
                                    <div class="project-details-files">
                                        <div class="view-mail-file-list">
                                            ...
                                            <div class="file-type-view">
                                                <h5><a href="#">Document-file.zip</a></h5>
