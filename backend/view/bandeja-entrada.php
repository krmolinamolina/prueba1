                                ...
                                <div class="col-lg-3">
                                    <div class="inbox-email-menu-list compose-b-mg-30 shadow-reset">
                                        <div class="compose-email">
                                            <a href="#">Redactar correo</a>
                                        </div>
                                        <ul class="nav nav-tabs">
                                            <li>
                                                <h4 class="Inbox-category-ad"><i class="far fa-folder" aria-hidden="true" ></i> Carpeta</h4>
                                            </li>
                                            <li class="active"><a data-toggle="tab" href="#inbox"><span class="inbox-icon"><i class="fas fa-inbox "></i></span> Inbox <span class="count-inbox">3</span></a>
                                            </li>
                                            <li><a data-toggle="tab" href="#viewmail"><span class="inbox-icon"><i class="fas fa-envelope-open-text"></i></span> Ver correo</a>
                                            </li>
                                            <li><a data-toggle="tab" href="#composemail"><span class="inbox-icon"><i class="fas fa-inbox "></i></span>Redactar correo</a>
                                            </li>
                                            <li><a data-toggle="tab" href="#started"><span class="inbox-icon"><i class="fas fa-globe-americas" aria-hidden="true"></i></span> General</a>
                                            </li>
                                            <li><a data-toggle="tab" href="#sendmail"><span class="inbox-icon"><i class="fas fa-paper-plane " aria-hidden="true"></i></span> Enviar correo</a>
                                            </li>
                                            <li><a data-toggle="tab" href="#important"><span class="inbox-icon"><i class="fas fa-star" aria-hidden="true"></i></span> Importante</a>
                                            </li>
                                            <li><a data-toggle="tab" href="#drafts"><span class="inbox-icon"><i class="far fa-file" aria-hidden="true"></i></span> Borradores <span class="count-inbox count-inbox-red">5</span></a>
                                            </li>
                                            <li><a data-toggle="tab" href="#trash"><span class="inbox-icon"><i class="fas fa-trash" aria-hidden="true"></i></span> Eliminados</a>
                                            </li>
                                            <li>
                                                <h4 class="Inbox-category-ad">Categorias</h4>
                                            </li>
                                            <li><a data-toggle="tab" href="#social"><span class="inbox-icon"><i class="fas fa-users" aria-hidden="true"></i></span> Social</a>
                                            </li>
                                            <li><a data-toggle="tab" href="#promosions"><span class="inbox-icon"><i class="fas fa-bolt" aria-hidden="true"></i></span> Promociones</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div id="inbox" class="tab-pane fade in animated zoomInDown custom-inbox-message shadow-reset active">
                                            <div class="mail-title inbox-bt-mg">
                                                ...
                                                <div class="view-mail-action view-mail-ov-d-n">
                                                    <a href="#"><i class="fa fa-reply"></i> Reenviar</a>
                                                        ...
                                                        <div class="text-editor-compose">
                                                            <div id="summernote5">
                                                                <div class="note-editable panel-body" contenteditable="true" style="height: 400px;">
                                                                   <!-- <h2 style="font-family: & quot;Open Sans&quot;, sans-serif; font-size: 18px;">-->
