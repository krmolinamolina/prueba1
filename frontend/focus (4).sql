...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-12-2019 a las 15:41:08
...
CREATE TABLE `evento` (
  ...
  `desEvento` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
  `fecIniEvento` date NOT NULL,
  `fecFinEvento` date NOT NULL,
  `imgEvento` varchar(30) COLLATE utf8mb4_spanish_ci NOT NULL,
  `titEvento` varchar(30) COLLATE utf8mb4_spanish_ci NOT NULL,
...
INSERT INTO `novedad` (`codNovedad`, `titNovedad`, `desNovedad`) VALUES
(1, 'nuevas muestras', 'la ultima tendencia');
...
--
ALTER TABLE `novedad`
  MODIFY `codNovedad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
