...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-12-2019 a las 18:38:03
...
CREATE TABLE `actividad` (
  ...
  `id_tipo_actividad` int(3) NOT NULL,
  `id_tecnico_actividad` varchar(11) COLLATE utf8mb4_spanish_ci NOT NULL,
  `codFuncionario` int(3) NOT NULL,
  `fecha_inicio_actividad` date NOT NULL,
  `hora_actividad` datetime NOT NULL,
  `observaciones_actividad` text COLLATE utf8mb4_spanish_ci NOT NULL,
  `evidencia_actividad` blob NOT NULL,
  `fecha_fin_actividad` date NOT NULL,
  `costo_actividad` float NOT NULL,
  `ubicacion_actividad` longtext COLLATE utf8mb4_spanish_ci NOT NULL
...
CREATE TABLE `arl` (
  `id_arl` int(2) NOT NULL,
  `nombre_arl` varchar(40) COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `departamento` (
  ...
  `nombre_departamento` mediumtext COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `detalle_maquina` (
  ...
  `codMaquina` varchar(20) COLLATE utf8mb4_spanish_ci NOT NULL,
...
CREATE TABLE `empresa_maquina` (
  ...
  `codMaquina` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL,
...
CREATE TABLE `experiencia_laboral` (
  ...
  `cargo_experiencia` text COLLATE utf8mb4_spanish_ci NOT NULL,
  `nombre_empresa_experiencia` text COLLATE utf8mb4_spanish_ci NOT NULL,
  `tiempo_laborado` varchar(3) COLLATE utf8mb4_spanish_ci NOT NULL,
  `descripcion_funciones_experiencia` varchar(200) COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `maquinaria` (
  `codMaquina` varchar(20) COLLATE utf8mb4_spanish_ci NOT NULL,
  `id_marca_maquina` int(3) NOT NULL,
  `id_referencia_maquina` int(4) NOT NULL,
  `id_tipo_maquina` int(4) NOT NULL,
  `nombre_maquina` text COLLATE utf8mb4_spanish_ci NOT NULL,
  `modelo_maquina` text COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `marca` (
  ...
  `nombre_marca` mediumtext COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `municipio` (
  ...
  `nombre_municipio` mediumtext COLLATE utf8mb4_spanish_ci NOT NULL,
  `id_departamento` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `perfil_tecnico` (
  `id_perfil_tecnico` int(11) NOT NULL,
  `id_tecnico` varchar(11) COLLATE utf8mb4_spanish_ci NOT NULL,
  `id_experiencia_laboral` int(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
INSERT INTO `persona` (`codPersona`, `id_municipio`, `priNomPersona`, `segNomPersona`, `priApePersona`, `segApePersona`, `dirPersona`, `fecNacPersona`) VALUES
...
CREATE TABLE `referencia_maquina` (
  `id_referencia_maquina` int(4) NOT NULL,
  `nombre_referencia_maquina` mediumtext COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `telefono_persona` (
  ...
  `id_persona` varchar(12) COLLATE utf8mb4_spanish_ci NOT NULL,
...
INSERT INTO `telefono_persona` (`id_telefono`, `id_persona`, `numTelefono`) VALUES
(1, '34234432', '71658982'),
(2, '34234432', '64642332');
...
CREATE TABLE `tipo_maquina` (
  `id_tipo_maquina` int(4) NOT NULL,
  `nombre_tipo` mediumtext COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `tipo_servicio` (
  ...
  `nombre_servicio` text COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
ALTER TABLE `actividad`
  ...
  ADD KEY `tipo_actividad` (`id_tipo_actividad`),
  ADD KEY `id_cliente` (`codFuncionario`),
  ADD KEY `id_tecnico_actividad` (`id_tecnico_actividad`);
...
ALTER TABLE `maquinaria`
  ...
  ADD KEY `id_marca_maquina` (`id_marca_maquina`),
  ADD KEY `id_referencia` (`id_referencia_maquina`),
...
ALTER TABLE `perfil_tecnico`
  ADD PRIMARY KEY (`id_perfil_tecnico`),
  ADD KEY `id_tecnico` (`id_tecnico`),
  ADD KEY `id_experiencia_laboral` (`id_experiencia_laboral`);
...
ALTER TABLE `referencia_maquina`
  ADD PRIMARY KEY (`id_referencia_maquina`);
...
--
ALTER TABLE `arl`
  MODIFY `id_arl` int(2) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `experiencia_laboral`
  MODIFY `id_experiencia` int(3) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `perfil_tecnico`
  MODIFY `id_perfil_tecnico` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `referencia_maquina`
--
ALTER TABLE `referencia_maquina`
  MODIFY `id_referencia_maquina` int(4) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `telefono_persona`
--
ALTER TABLE `telefono_persona`
  MODIFY `id_telefono` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `tipo_actividad`
--
ALTER TABLE `tipo_actividad`
  MODIFY `id_tipo_actividad` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tipo_maquina`
--
ALTER TABLE `tipo_maquina`
  MODIFY `id_tipo_maquina` int(4) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `actividad`
  ...
  ADD CONSTRAINT `actividad_ibfk_2` FOREIGN KEY (`id_tecnico_actividad`) REFERENCES `tecnico` (`id_tecnico`);

--
-- Filtros para la tabla `detalle_maquina`
--
ALTER TABLE `detalle_maquina`
  ADD CONSTRAINT `detalle_maquina_ibfk_1` FOREIGN KEY (`codMaquina`) REFERENCES `maquinaria` (`codMaquina`);
...
ALTER TABLE `empresa_maquina`
  ...
  ADD CONSTRAINT `empresa_maquina_maquina_fk` FOREIGN KEY (`codMaquina`) REFERENCES `maquinaria` (`codMaquina`);
...
ALTER TABLE `historial_maquina`
  ...
  ADD CONSTRAINT `historial_maquina_ibfk_1` FOREIGN KEY (`id_actividad`) REFERENCES `actividad` (`id_actividad`);

--
-- Filtros para la tabla `maquinaria`
--
ALTER TABLE `maquinaria`
  ADD CONSTRAINT `maquinaria_ibfk_1` FOREIGN KEY (`id_tipo_maquina`) REFERENCES `tipo_maquina` (`id_tipo_maquina`),
  ADD CONSTRAINT `maquinaria_ibfk_2` FOREIGN KEY (`id_referencia_maquina`) REFERENCES `referencia_maquina` (`id_referencia_maquina`),
  ADD CONSTRAINT `maquinaria_ibfk_3` FOREIGN KEY (`id_marca_maquina`) REFERENCES `marca` (`id_marca`);
...
--
ALTER TABLE `perfil_tecnico`
  ADD CONSTRAINT `perfil_tecnico_ibfk_1` FOREIGN KEY (`id_tecnico`) REFERENCES `tecnico` (`id_tecnico`),
  ADD CONSTRAINT `perfil_tecnico_ibfk_2` FOREIGN KEY (`id_experiencia_laboral`) REFERENCES `experiencia_laboral` (`id_experiencia`);
...
--
ALTER TABLE `tecnico`
  ADD CONSTRAINT `tecnico_ibfk_2` FOREIGN KEY (`id_arl`) REFERENCES `arl` (`id_arl`),
...
--
ALTER TABLE `telefono_persona`
  ADD CONSTRAINT `telefono_persona_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`codPersona`);
